...
('Poppy', 'large', (SELECT user_id FROM Users WHERE username = 'davidwalker')),
('Shadow', 'medium', (SELECT user_id FROM Users WHERE username = 'alice123')),
('Gypsy', 'small', (SELECT user_id FROM Users WHERE username = 'emilyowner'));
